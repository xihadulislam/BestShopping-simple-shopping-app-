...
public class CartReqActivity extends AppCompatActivity {
    ...
    private EditText orderId, TaxId,phn,add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final CartData cartDataadmin = new CartData(ord,trx,id,user.getUid(),upusid,price,address,phone);
                ...
                databaseReference.child(id).setValue(cartData).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        startActivity(new Intent(CartReqActivity.this,Main2222Activity.class));
                    }
                });
