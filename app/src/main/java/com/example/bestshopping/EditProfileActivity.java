...
public class EditProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && data != null && data.getData() != null) {
            ...
            muri = data.getData();
            Glide.with(EditProfileActivity.this).load(muri).into(propic);
        }
    }
    ...
    public  void  callDatabase(){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String des = dataSnapshot.child("address").getValue().toString();
                String ing = dataSnapshot.child("imageuri").getValue().toString();
                username.setText(uname);
                description.setText(des);

                try {

                    Glide.with(EditProfileActivity.this).load(ing).into(propic);
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private  void  upload(){
        ...
        if (muri != null) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    databaseReference.child("address").setValue(Descriptiom);
            ...
            progressDialog.dismiss();
            databaseReference.child("username").setValue(userName);
            databaseReference.child("address").setValue(Descriptiom).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
